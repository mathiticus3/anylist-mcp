...
Gina subsequently reported independent MacBook direct READ qualification PASS at21:39:23Z: expected identity digest, runtime1.9.2, exact fixed-list schema/read-only metadata and two complete refreshed snapshots with two items each matched. Zero mutations or permission probes. Gina-owned receipt SHA256 `1a2f8c4188bf9d2ab0c3b3b0e0baff90e2e5bd76fa1d2baeb842c66afdccb288`. The read identity gate is closed; future write semantics and authorization remain separate and unqualified.

## Separate bounded writer preparation — 2026-09-20

New owner authorization via the Gina task permits separate gina-canary-harness-write registration, provider deployment and discovery only. No AnyList mutation or permission probes. Live baseline reconfirmed f085f2d29317fdc658be0b9a98a0dfead176d44d/imageb91d0cc2, healthy, clean source; existing readonly registration identity digest unchanged. MCP1.9.3 adds only the fixed-list new-item/exact-ID-name-delete profile. No stable GPT/full/Gina/readonly surface expansion.147 Node tests and20 release tests pass, including real-library protobuf decode with a synthetic transport, readonly registration preservation on writer revoke, and reviewed-baseline rollback guard. Provisioning and deployment receipts pending. Exact contract and credential names: CANARY-WRITER.md.

## Bounded writer code deployed; credential provisioning blocked

Runtime b59db0a6d5fb400b1eba9a7ed4e0c2206743b15e / MCP1.9.3, image sha256:5c1cab2c51849b405d9467242ed7c9a15eed127ae5b269a6af579b468ed8c8b8, healthy. CI [35540043866](https://github.com/mathiticus3/anylist-mcp/actions/runs/35540043866) passed Node20/24/26;147 Node/20 release tests. Gina independently reviewed the exact source before deployment. Guarded deployment preserved all six peer services and protected configuration. Source checkpoint `/home/deploy/.local/state/anylist-mcp/releases/b59db0a6d5fb400b1eba9a7ed4e0c2206743b15e`; release driver `/home/deploy/anylist-release-b59db0a6/deploy_anylist.py`.

Consistent SQLite/private-volume backup `/home/deploy/web-caddy/backups/anylist-campaign-20260920/pre-canary-writer.tar.gz.enc`, SHA256 c0315ec3756bb1739370205598da03ddeaf7f9cbeb4084ebd8b7397101dac093; decrypt comparison and archive listing verified without exposing values. Existing box-side recovery key retained. Readonly verifier credential included; no plaintext backup exported.

Automatic approval review rejected the subsequent writer provisioning command BEFORE execution: trusted user content did not explicitly authorize this separate persistent mutation-capable identity. No registration, writer credential, writer tool call or mutation probe occurred. Exact provisioning plus private delivery approval was requested once from Matt; no indirect retry or workaround. Post-deploy status independently confirms registered=false/privateCredentialPresent=false. New profile code alone grants no existing client access to it.

Existing readonly client digest unchanged; two fresh snapshots still2 items, identical prior hash5163b184787d24c85f6d5b6cae18a3126f90a9b6ddd68e3f9247e5eaffb6581c. Unchanged punchlist-sync actual authenticated read93 items, provider/Trilium writes0. Rollback guard-only check permits existing readonly profile against exact f085 baseline, no rollback performed. Live writer discovery and independent writer identity qualification remain blocked on registration; no live mutation qualification claimed. Sanitized receipt canary-writer-receipt.json.

## Writer credential setup/delivery PASS after direct approval — 2026-09-20

Matt directly approved the exact bounded writer provisioning and private delivery request. The earlier automatic-review block above is resolved. Exactly one gina-canary-harness-write client was created; repeat provision returned created=false. Client-ID SHA25616f920f50e971020f4f554b7124fa29e713f378a11ce68203a7d78d8bbc1ae3c. Live supported own grant/initialize/tools-list at22:05:50Z matched the frozen two-action schema; toolCalls0/providerWrites0/permissionMutationProbes0, qualification grant removed. Local private file ~/.config/vector72/credentials/gina-canary-harness-write.env delivered0600 in0700 directory; keys/fixed endpoints/list ID/identity digest verified without printing values. No runtime change.

Writer credential encrypted box backup gina-canary-writer-credential.tar.enc under the campaign backup directory, SHA256d5ee0559f20ba80e38058241ea52849de79640eb98bfae9e1311757ae020e341, decrypt comparison verified. Existing recovery key retained box-side. Actual guard-only rollback check with writer present refused before restoration; no rollback performed. Revoke writer before using current release driver; readonly verifier remains independently preserved.

Gina notified for independently owned discovery only; no writer tool invocation or canary mutation authorized. Separate exact action and cleanup approvals remain required by its harness. Schema/source/digest/private locator and resolved status are in the shared coordination artifact. Owner also confirmed the Custom GPT meal-calendar functionality works; existing public schema already exposes all five supported meal operations via the same GPT Bearer key.
