...
**Rollback update after dedicated canary provisioning:** revoke the separate gina-canary-harness custom-profile client before any older-runtime rollback. Use the guarded driver packaged with f085f2d or later; retained old drivers cannot enforce this. Details: [CANARY-READONLY.md](CANARY-READONLY.md). This does not change GPT authority or credentials.
